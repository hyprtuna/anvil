#!/usr/bin/env bash
# Anvil default statusline (v0.8.1) — truecolor RGB gradient
# repo · 🌿 branch · 20-block ctx bar · emoji · ctx% · 7d% · 5h% · velocity · 🤖 model
# Single line, no dependencies beyond jq + awk + date + git.
# Install: anvil statusline install --mode shell-script [--scope global|project]
